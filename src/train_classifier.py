...
def main():
    ...
    ap.add_argument("--dataset", type=str, default="tatoeba", choices=['tatoeba','flores','papluca'])
    ap.add_argument("--seen_langs", type=str, default="en,es,de,fr,it")
    ap.add_argument("--max_per_lang", type=int, default=5000)
    ap.add_argument("--model_name", type=str, default="distilbert-base-multilingual-cased")
    ...
    model = AutoModelForSequenceClassification.from_pretrained(
        args.model_name, num_labels=len(label_list), id2label={i:l for i,l in enumerate(label_list)}, label2id=label2id
    )
